        ...
        <div class="child">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control is-invalid" id="validationServer222" placeholder="State"
                       readonly  name="maNhanVien" value="${employee.getMaNhanVien()}"></div>
            <div class="form-group">
                <label for="validationServer04">Họ và tên</label>
                <input type="text" class="form-control is-invalid" id="validationServer04" placeholder="State"
                       required  name="nameEmployee" value="${employee.getName()}"></div>
                <div class="form-group">
